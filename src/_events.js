...
get.leftArrowBtn.addEventListener('click', () => {
    ...
    filterdots.forEach(dot => {
        ...
        if (dot.dataset.value == sliderIndex || dot.dataset.value == slider.allSlides.length - 1 && sliderIndex == -1) {
            dot.classList.toggle('fill')
        } 
...
get.rightArrowBtn.addEventListener('click', () => {
    ...
    filterdots.forEach(dot => {
        ...
        if (dot.dataset.value == sliderIndex || dot.dataset.value == 0 && sliderIndex == 4) {
            dot.classList.toggle('fill')
        } 
